    ...
    <Box
      ...
      <Box
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Input type='firstName' name='first name' id='firstName' {...register('firstName')} mb={3} />
          <Label
            htmlFor='email'
            sx={{
              fontWeight: 'bold',
          ...
          <Input type='email' name='email' id='email' {...register('email')} mb={3} />
          <Button type='submit'>Submit</Button>
        </form>
      </Box>
      <Modal open={open} sx={{ content: '""', bg: 'background', borderRadius: '4px', transition: 'all 0.3s', position: 'absolute', left: '0', right: '0', bottom: '0', top: '0', height: '100%', width: '100%', zIndex: '2', p: ['.5rem'], display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
