  ...
  return (
    ...
    >
      ...
      >
        ...
        <Styled.p sx={{ fontFamily: 'monospace', color: 'white' }}>
          All I ask is that you treat me, my time (work and family need to come
          first), and my equipment with respect (and maybe feed me, if you
          want).
        </Styled.p>
        <Styled.p sx={{ fontFamily: 'monospace', color: 'white' }}>
          If this sounds good then add your details below and I'll get back to
          you as time allows. I'll try my hardest to help as many folks as I can
